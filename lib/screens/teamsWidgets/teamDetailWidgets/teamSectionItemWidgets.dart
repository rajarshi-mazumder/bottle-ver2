...
class TeamDetailItemShort extends StatelessWidget {
  TeamDetailItemShort({super.key,
...
class TeamDetailItemLong extends StatelessWidget {
  TeamDetailItemLong({super.key,
    this.textFontSize = 12,
    required this.labelText,
