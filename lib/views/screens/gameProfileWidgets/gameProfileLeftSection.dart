...
import 'package:bottle_ver2/views/screens/gameProfileWidgets/playerCardWidgets/valorantPlayerCardWidgets.dart';
...
class _GameProfileLeftSectionState extends State<GameProfileLeftSection> {
  ...
  Widget build(BuildContext context) {
    ...
    widget.cardWidth = customSpacing.getLeftSectionWidth(context: context);
    return Container(
          ...
          children: [
            Column(
              children: [
                Image.asset(
                  '/Reyna-1.png',
                  width: customSpacing.getLeftSectionWidth(context: context),
                  fit: BoxFit.cover,
                ),
                ClipRRect(
