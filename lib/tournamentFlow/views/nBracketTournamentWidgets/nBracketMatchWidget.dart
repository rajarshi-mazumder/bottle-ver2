...
class NBracketMatchWidget extends StatefulWidget {
  NBracketMatchWidget(
      {Key? key,
  ...
  @override
  State<NBracketMatchWidget> createState() => _NBracketMatchWidgetState();
}

class _NBracketMatchWidgetState extends State<NBracketMatchWidget> {
